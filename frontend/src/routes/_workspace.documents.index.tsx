...
import { FileText, Filter, RotateCcw, Search, ShieldCheck, SlidersHorizontal } from "lucide-react";
import { DocumentsTable } from "@/documents/components/DocumentsTable";
import { useUserProfile } from "@/auth/use-user-profile";
import { getDocumentFilterOptions, isDocumentInUserScope, listDocuments } from "@/api/workspace-service";
