...
export function Particles({
  ...
  const onMouseMove = () => {
    if (canvasRef.current) {
      ...
      const inside = mousePosition.current.x < rect.right && mousePosition.current.x > rect.left && mousePosition.current.y < rect.bottom && mousePosition.current.y > rect.top;
      if (inside) {
