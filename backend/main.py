...
# SPA authentication uses Authorization: Bearer <JWT> rather than
# credentialed cross-origin cookies. Keep the allowed origins restricted,
# but allow the browser's Authorization preflight to proceed.
app.add_middleware(
    CORSMiddleware,
