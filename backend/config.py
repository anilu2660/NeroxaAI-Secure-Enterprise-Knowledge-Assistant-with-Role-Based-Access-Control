...
class Settings:
    ...
    QDRANT_API_KEY: str | None = os.getenv(
        "QDRANT_API_KEY",
        None,
    )
    ...
    MICROSOFT_CLIENT_ID: str = os.getenv(
        "MICROSOFT_CLIENT_ID",
        "",
    )

    MICROSOFT_CLIENT_SECRET: str = os.getenv(
        "MICROSOFT_CLIENT_SECRET",
        "",
    )

    MICROSOFT_TENANT_ID: str = os.getenv(
        "MICROSOFT_TENANT_ID",
        "common",
    )
